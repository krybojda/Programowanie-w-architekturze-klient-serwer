    ...
    <div class="main">
        <?php
          ...
          if (mysqli_num_rows($query) > 0) {
            ...
            echo "<tr><th>ID Rezerwacje</th><th>Typ</th><th>Nazwa</th><th>Cena</th><th>Suma</th><th>Zwróć</th></tr>";
              while($row = mysqli_fetch_assoc($query)) {
                      echo "<tr>";
                      ...
                      echo "<td class='text-center'><button onclick='url(" . $row["id_Rezerwacje"] . ")'>Zwróć</button></td>";
                      echo "</td>";
              }
              echo "</table>";
            }
